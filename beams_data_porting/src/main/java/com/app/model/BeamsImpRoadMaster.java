 ...
 * @Entity
 * 
 * @Table(name="beams_imp_road_work_master_new") public class BeamsImpRoadMaster
 * {
 * 
 * @Id
 * 
 * @Column(name="PORTING_Id") private Integer portingId;
 * 
 ...
 * 
 * public BeamsImpRoadMaster() { super(); // TODO Auto-generated constructor
 * stub }
 * 
 * public BeamsImpRoadMaster(Integer portingId, Integer uniqueId, Long workId,
 * String workNameEnglish, String worksNameMarathi, String approvalNo, LocalDate
 ...
 * LocalDate insertDateTime) { super(); this.portingId = portingId;
 * this.uniqueId = uniqueId; this.workId = workId; this.workNameEnglish =
 * workNameEnglish; this.worksNameMarathi = worksNameMarathi; this.approvalNo =
 * approvalNo; this.approvalDate = approvalDate; this.estimatedCost =
 * estimatedCost; this.roadNo = roadNo; this.chainageFrom = chainageFrom;
 * this.chainageTo = chainageTo; this.taluka = taluka; this.constitutionId =
 * constitutionId; this.controllingOfficerCode = controllingOfficerCode;
 * this.workInd = workInd; this.workType = workType; this.workCategory =
 * workCategory; this.userDept = userDept; this.carpetArea = carpetArea;
 * this.remark = remark; this.bookValue = bookValue; this.constructedYear =
 * constructedYear; this.budgetYear = budgetYear; this.budgetMonth =
 * budgetMonth; this.budgetBookPageNo = budgetBookPageNo;
 ...
 * 
 * public Integer getPortingId() { return portingId; }
 * 
 * public void setPortingId(Integer portingId) { this.portingId = portingId; }
 * 
