...
@Entity
@Table(name="BeamsData_22AugT28Aug")
public class BeamsWorksMaster {
	
	@Id
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	@Column(name="PORTING_Id")
	...
	@Column(name = "workId")
	private Long workId;
	@Column(name = "Work_Name_English",length = 666)
	private String workNameEnglish;
	
	@Column(name = "Work_Name_Marathi",length = 666)
	private String worksNameMarathi;
	...
	@Column(name = "CONTROLLING_OFFICER_CODE")
	private String controllingOfficerCode;
	...
	@Column(name = "Budget_Book_Page_No")
	private Integer budgetBookPageNo;
	@Column(name = "Budget_Book_Serial_No")
	private Integer budgetBookSerialNo;
	@Column(name = "Chief_Engineer")
	private String chiefEnginner;
	@Column(name = "Subdivision")
	private Long subDivision;
	@Column(name = "Technical_Sanction_Date")
	private LocalDate technicalSactionDate;
	@Column(name = "TECHNICAL_SANCTION_AMT")
	private Double technicalSactionAmt;
	@Column(name = "Bitumen_Quantity")
	private Double bitumenQuntity;
	@Column(name = "TENDER_AMT")
	private Double tenderAmt;
	@Column(name = "Agreement_Cost")
	...
	@Column(name = "Scope",length = 555)
	private String scope;
	@Column(name = "ADMIN_DEPT")
	private String adminDept;
	@Column(name = "Additional_Estimated_Cost")
	private Integer additionalEstimatedCost;
	@Column(name = "ADDI_ESTIM_COST_APPR_DT")
	private LocalDate addiEstimCostApprDt;
	@Column(name = "Work_Entry_Date")
	private LocalDate workEntryDate;
	@Column(name = "Admin_Update_Date")
	private LocalDate adminUpdateDate;
	
	
	
	public BeamsWorksMaster() {
		super();
	...
	public BeamsWorksMaster(Integer uniqueId, Long workId, String workNameEnglish, String worksNameMarathi,
			String approvalNo, LocalDate approvalDate, Double estimatedCost, Integer roadNo, Double chainageFrom,
			Double chainageTo, Integer taluka, Integer constitutionId, String controllingOfficerCode, String workInd,
			String workType, String workCategory, String userDept, Double carpetArea, String remark,
			Integer bookValue, Integer constructedYear, Integer budgetYear, Integer budgetMonth,
			Integer budgetBookPageNo, Integer budgetBookSerialNo, String chiefEnginner, Long subDivision,
			LocalDate technicalSactionDate, Double technicalSactionAmt, Double bitumenQuntity, Double tenderAmt,
			Double agreementCost, Double percentage, LocalDate workOrderDate, Integer timeLimit, String scope,
			String adminDept, Integer additionalEstimatedCost, LocalDate addiEstimCostApprDt, LocalDate workEntryDate,
			LocalDate adminUpdateDate) {
		super();
		this.uniqueId = uniqueId;
		this.workId = workId;
		this.workNameEnglish = workNameEnglish;
		...
		this.bitumenQuntity = bitumenQuntity;
	...
	public String getWorkNameEnglish() {
		return workNameEnglish;
	}



	public void setWorkNameEnglish(String workNameEnglish) {
		this.workNameEnglish = workNameEnglish;
	}



	public String getWorksNameMarathi() {
		return worksNameMarathi;
	}
	...
	public String getControllingOfficerCode() {
		return controllingOfficerCode;
	}
	...
	public Integer getBudgetBookPageNo() {
		return budgetBookPageNo;
	}
	...
	public Integer getBudgetBookSerialNo() {
		return budgetBookSerialNo;
	}
	...
	public String getChiefEnginner() {
		return chiefEnginner;
	}



	public void setChiefEnginner(String chiefEnginner) {
		this.chiefEnginner = chiefEnginner;
	}
	...
	public LocalDate getTechnicalSactionDate() {
		return technicalSactionDate;
	}
	...
	public Double getTechnicalSactionAmt() {
		return technicalSactionAmt;
	}
	...
	public Double getBitumenQuntity() {
		return bitumenQuntity;
	}



	public void setBitumenQuntity(Double bitumenQuntity) {
		this.bitumenQuntity = bitumenQuntity;
	}
	...
	public Double getAgreementCost() {
		return agreementCost;
	}



	public void setAgreementCost(Double agreementCost) {
		this.agreementCost = agreementCost;
	}
	...
	public Integer getAdditionalEstimatedCost() {
		return additionalEstimatedCost;
	}
	...
	public LocalDate getAddiEstimCostApprDt() {
		return addiEstimCostApprDt;
	}
	...
	public LocalDate getWorkEntryDate() {
		return workEntryDate;
	}



	public void setWorkEntryDate(LocalDate workEntryDate) {
		this.workEntryDate = workEntryDate;
	}



	public LocalDate getAdminUpdateDate() {
